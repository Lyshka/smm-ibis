...
const PriceBlockMobile = ({ priceByn, priceRub, services, month = false }) => {
  ...
  return (
    <div className="min-w-[264px] shadowPrice rounded-2xl">
      <h3 className="px-6 py-4">Контекстная реклама</h3>

      <div className="bg-[#FF3A2D] p-6 text-white w-full">
        <div className="flex text-lg flex-col gap-y-4">
          <p className="font-bold text-center">
            от <span className="font-black text-[29px]">{priceByn}</span> BYN{month && ("/мес.")}
          </p>

          <p className="font-bold text-center">
            от <span className="font-black text-[29px]">{priceRub}</span> RUB{month && ("/мес.")}
          </p>
        </div>
      </div>
