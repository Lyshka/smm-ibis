...
const Navbar = () => {
  return (
    <div className="min-w-[221px] overflow-hidden overflow-y-scroll h-[800px] sticky top-20 navbar">
      ...
      <NavbarBlock url={"https://smm-ibis.by/tiktokpromotion/"} title={"TikTok продвижение"}/>
      ...
      <NavbarBlock url={"https://smm-ibis.by/funktsionalnyyotdelmarketinga/"} check title={"Функциональный отдел маркетинга"}/>
    </div>
  );
};
